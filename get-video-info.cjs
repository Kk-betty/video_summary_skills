...
console.log('Getting real video info for:', bvid);
  ...
  res.on('end', () => {
    try {
      ...
      if (result.code === 0 && result.data) {
        console.log('✅ Success! Got real video data:');
        ...
        console.log('Desc:', result.data.desc ? result.data.desc.substring(0, 300) + '...' : 'N/A');
      } else {
